...
To track your habits, just right click to mark red and left click to mark green.
Example:
```
ACTIVITIES = [
    "School",
...
It's made in a way that the file will be reused the next year, and as of right now it will open with the data you had the year.
